...
void main() {
  group(
    ...
    (() {
      ...
      test('Should be able to be initiazlied ', (() async {
      ...
      test(
        'Test should fail if takes more then 2 secs',
        () async {
          await provider.initialize();
          expect(provider.isInitialized, true);
        },
...
class MockAuthProvider implements Authprovider {
  AuthUser? _user; // no need to assign null its implicitly applied

  var _isInitialized = false;
  bool get isInitialized => _isInitialized; // this getter for isinitialized
  ...
  Future<AuthUser> logIn({
    ...
    const user = AuthUser(
        isEmailVerified: false); // creates a user and assigns it a value
    _user = user;
